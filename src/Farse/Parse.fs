...
module Parse =
    ...
    let inline private stringError ([<InlineIfLambda>] fn) expectedKind : Parser<'r> =
        Parser (fun element ->
            match expectedKind with
            | IsExpectedKind element ->
    ...
    /// <summary>Parses a string as <c>System.String</c>.</summary>
    /// <example><code>let! string = "prop" &amp;= Parse.string</code></example>
    let string = customError (_.GetString() >> Ok) ExpectedKind.String

    /// <summary>Parses a non-empty, non-whitespace string as <c>System.String</c>.</summary>
    ...
    /// <summary>Parses a base64 string as <c>System.Byte array</c>.</summary>
    ...
    /// <summary>Parses a number as <c>System.Numerics.BigInteger</c>.</summary>
    ...
    let bool = customError (_.GetBoolean() >> Ok) ExpectedKind.Bool

    /// <summary>Parses a string as <c>System.Guid</c>.</summary>
    ...
    let unit = customError (ignore >> Ok) ExpectedKind.Null

    /// <summary>Always succeeds and returns <c>FSharp.Core.Unit</c>.</summary>
    ...
    /// <summary>Parses a string as <c>System.TimeOnly</c>.</summary>
    ...
    /// <summary>Parses a string as <c>System.Uri</c> with a specific <c>UriKind</c>.</summary>
    ...
    /// <summary>Parses a string as <c>System.Net.IPAddress</c>.</summary>
    ...
    /// <summary>Parses a string as <c>System.Net.Mail.MailAddress</c>.</summary>
    ...
    /// <summary>Parses an array with two values as <c>'a * 'b</c>.</summary>
    ...
    /// <summary>Parses an array with three values as <c>'a * 'b * 'c</c>.</summary>
    ...
    /// <summary>Parses an array with four values as <c>'a * 'b * 'c * 'd</c>.</summary>
    ...
    /// <summary>Parses an array with five values as <c>'a * 'b * 'c * 'd * 'e</c>.</summary>
    ...
    let kind = Parser (_.ValueKind >> Ok)

    /// <summary>Parses an element as <c>System.Text.Json.JsonElement</c>.</summary>
    /// <example><code>let! jsonElement = "prop" &amp;= Parse.element</code></example>
    let element = Parser (JsonElement.clone >> Ok)

    /// <summary>Parses an element's raw text as <c>System.String</c>.</summary>
    /// <example><code>let! string = "prop" &amp;= Parse.rawText</code></example>
    let rawText = customError (_.GetRawText() >> Ok) ExpectedKind.Any

    /// <summary>Parses an array's length as <c>System.Int32</c>.</summary>
    /// <example><code>let! int = "prop" &amp;= Parse.arrayLength</code></example>
    let arrayLength = customError (_.GetArrayLength() >> Ok) ExpectedKind.Array

    /// <summary>Parses an object's property count as <c>System.Int32</c>.</summary>
    /// <example><code>let! int = "prop" &amp;= Parse.propertyCount</code></example>
    let propertyCount = customError (_.GetPropertyCount() >> Ok) ExpectedKind.Object